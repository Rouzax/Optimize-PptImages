# This file is auto-extracted from the original Optimize-PptImages.ps1 begin block.
# All helper functions, the enum, and the classes live here. Do not reorder.
